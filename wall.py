...
# 将图片加载
brickImage = resource_path("image/wall/brick.png")
ironImage = resource_path("image/wall/iron.png")
riverImage = resource_path("image/wall/river1.png")
treeImage = resource_path("image/wall/tree.png")
iceImage = resource_path("image/wall/ice.png")
# 基地的图片
homeImage = resource_path("image/home.png")
