...
class SE:
    def __init__(self):
        ...
        # 初始化保护罩的图片
        protect_image = pygame.image.load(resource_path("image/special_effects/protect.png")).convert_alpha()
        self.protect = []
        self.protect.append(protect_image.subsurface((0, 0), (48, 48)))
        self.protect.append(protect_image.subsurface((48, 0), (48, 48)))

        # 敌军坦克出现动画
        appearance_image = pygame.image.load(resource_path("image/special_effects/appear.png")).convert_alpha()
        self.appearance = []
        ...
        # 子弹爆炸特效
        boom_dynamic_image = pygame.image.load(resource_path("image/special_effects/boom_dynamic.png")).convert_alpha()
        self.boom = []
