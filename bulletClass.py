...
class Bullet(pygame.sprite.Sprite):
    def __init__(self):
        ...
        # 将子弹”上下左右“的图片进行加载
        self.bullet_up = pygame.image.load(resource_path("image/bullet_up.png"))
        self.bullet_down = pygame.image.load(resource_path("image/bullet_down.png"))
        self.bullet_left = pygame.image.load(resource_path("image/bullet_left.png"))
        self.bullet_right = pygame.image.load(resource_path("image/bullet_right.png"))
